    ...
    <header className="flex items-center gap-x-3 px-[100px] bg-white">
      ...
      <div className="flex ml-auto gap-x-3 z-20">
        {auth ? (
              ...
              renderPopover={
                <div className="bg-gray-100 relative shadow-md rounded-sm border border-gray-200 z-20 w-full">
                  <div className="flex flex-col py-2 pr-20 ">
                    <button className="py-2  hover:text-red-800 ">
                      Tiếng Việt
                    </button>
                    <button className="py-2 hover:text-red-800 ">
                      English
          ...
          <>
            <Popover
              className="flex items-center py-1 hover:text-gray-300 cursor-pointer ml-6  bg-red-500  text-white font-medium px-2 rounded-lg"
              renderPopover={
                <div className="bg-white relative shadow-md rounded-sm border border-gray-200 pr-20">
