    ...
    <header className="flex items-center gap-x-3 px-[100px] bg-white">
      ...
      <div className="flex ml-auto gap-x-3">
        {auth ? (
          <>
            <Popover
              className="flex items-center py-1 hover:text-gray-300 cursor-pointer bg-red-300 z-20"
              renderPopover={
                <div className="bg-white relative shadow-md rounded-sm border border-gray-200 z-20">
