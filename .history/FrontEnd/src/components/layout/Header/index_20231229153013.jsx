...
export default function Header() {
  ...
  return (
    <header className="flex items-center gap-x-3 px-[100px] bg-white z-20">
      ...
      <div className="flex ml-auto gap-x-3">
        {auth ? (
          ...
          <>
            <Popover
              className="flex items-center py-1 hover:text-gray-300 cursor-pointer  z-40 bg-red-500 text-white font-medium px-2 rounded-lg"
              renderPopover={
