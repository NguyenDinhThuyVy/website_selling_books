    ...
    <header className="flex items-center gap-x-3 px-[100px] bg-white">
      ...
      <div className="flex ml-auto gap-x-3 z-20">
        {auth ? (
          <>
            <Popover
              className="flex items-center py-1 hover:text-gray-300 cursor-pointer ml-6  bg-rose-600  text-white font-medium px-2 rounded-lg"
              renderPopover={
          ...
          <>
            <Popover
              className="flex items-center py-1 hover:text-gray-300 cursor-pointer ml-6  bg-rose-400  text-white font-medium px-2 rounded-lg"
              renderPopover={
                <div className="bg-white relative shadow-md rounded-sm border border-gray-200">
                  <button className="block py-3 px-4 hover:bg-slate-100 bg-white hover:text-red-600 w-full text-left pr-20">
                    Tiếng Việt
