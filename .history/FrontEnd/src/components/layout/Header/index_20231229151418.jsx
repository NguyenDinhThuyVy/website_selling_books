    ...
    <header className="flex items-center gap-x-3 px-[100px] bg-white">
      ...
      <div className="flex ml-auto gap-x-3">
        {auth ? (
          <>
            <Popover
              className="flex items-center py-1 hover:text-gray-300 cursor-pointer bg-red-300 z-40"
              renderPopover={
                <div className="bg-white relative shadow-md rounded-sm border border-gray-200 z-40">
          ...
          <>
            <Popover
              className="flex items-center py-1 hover:text-gray-300 cursor-pointer  z-40 bg-red-500 text-white w"
              renderPopover={
                <div className="bg-red-300 relative shadow-md rounded-sm border border-gray-200 z-40 font-bold">
                  <div className="flex flex-col py-2 pr-28 pl-3">
                    <button className="py-2 px-3 hover:text-orange">
                      Tiếng Việt
                    </button>
