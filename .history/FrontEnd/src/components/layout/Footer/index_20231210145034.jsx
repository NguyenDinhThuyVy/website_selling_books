      ...
      <div className="flex items-center gap-x-10 wrapper-content">
        <div className="w-[30%] border-r border-r-gray-500">
          ...
          <p className="pr-2 mb-3 text-sm font-medium">
            ZyMy bán sách và giao hàng tận nơi. Không hỗ trợ đặt mua và nhận
            hàng trực tiếp tại văn phòng cũng như tất cả hệ thống ZyMy trên toàn
            quốc.
          </p>
          <div className="ml-16">
        ...
        <div className="w-[70%] flex">
          <div className="flex flex-col gap-y-2 w-[33.33%]">
            ...
            <Link
              ...
              className="text-sm hover:text-[#ce1515c4] transition-all w-max"
            >
              Giới thiệu NTHĐV
            </Link>
            <Link
          ...
          <div className="flex flex-col gap-y-2 w-[33.33%] cursor-pointer">
            ...
            <span className="text-sm hover:text-[#ce1515c4] transition-all w-max flex items-center gap-x-2">
