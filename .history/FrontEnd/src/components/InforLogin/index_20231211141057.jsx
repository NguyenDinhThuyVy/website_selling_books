    ...
    <div className="relative font-semibold infor">
      ...
      <div className="absolute z-10 w-[300px] p-3 -translate-x-[180px] top-[60px] bg-[#eee] shadow-lg rounded-md infor-content">
        ...
        <div className="flex flex-col pt-3 pl-5 gap-y-[2px]">
          <Link
            href={routes.PROFILE}
            className="hover:text-[#ce1515c4] transition-all flex items-center gap-x-2"
          >
            <FaUser />
            Thông tin cá nhân
          </Link>
          ...
          <span
            ...
            className="cursor-pointer hover:text-[#ce1515c4] transition-all flex items-center gap-x-2"
          >
            <IoLogOut />
            Đăng xuất
          </span>
