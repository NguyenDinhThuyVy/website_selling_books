      ...
      {isLoading ? (
        ...
        <div className={`content-wrapper ${routeLoading ? 'cursor-wait' : ''}`}>
          ...
          <div className="flex px-[20px] flex-col justify-start">
            ...
            <div>
              <div className="flex max-w-full max-h-[300px] flex-row gap-x-[30px] mx-1 ">
                <div className="max-w-[220px] h-auto flex flex-col">
                  {' '}
                  <img
                    src={book?.mainImage[0].url}
                    alt=""
                    className="w-full max-h-[290px] rounded-lg pb-1 cursor-pointer"
                  />
                  <div className="text-xl flex items-center justify-center w-full font-bold hover:text-black/60 cursor-pointer">
                    {book?.booktitle}
                  </div>
                </div>
                <div className="max-w-[220px] h-auto">
                  {' '}
                  <img
                    src={book?.mainImage[0].url}
                    alt=""
