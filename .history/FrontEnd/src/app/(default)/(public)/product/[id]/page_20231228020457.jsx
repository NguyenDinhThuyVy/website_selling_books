    ...
    <section className="content">
      {isLoading ? (
        ...
        <div className={`content-wrapper ${routeLoading ? 'cursor-wait' : ''}`}>
          ...
          {/* <!-- related books -->/ */}
          <div className="flex px-[20px] flex-col">
            <div className="text-[24px]">Có thể bạn sẽ thích</div>
            <div>
              <div className="flex max-w-[250px] max-h-[300px] flex-col items-center justify-center ">
                <img
                  src={book?.mainImage[0].url}
                  alt=""
                  className="max-w-[250px] max-h-[280px]"
                />
              </div>
            </div>
          </div>
