                ...
                <div className="product-information lg:w-[60%] w-full">
                  ...
                  <div className="orther-information pb-[10px]">
                    <div className="release-date">
                      <span className="orther-title">Ngày phát hành</span>
                      <span className="info">{formattedDate}</span>
                    </div>
                    <div className="publisher">
                      <span className="orther-title">Nhà xuất bản</span>
                      <span className="info">{book?.publisher}</span>
                    </div>
                    <div className="developer">
                      <span className="orther-title">Tác giả</span>
                  ...
                  <div className="product-payment">
                    <div className="add">
                      ...
                      <button className="product-add" onClick={handleAddCart}>
                        <span className="add-text">Thêm vào giỏ</span>
                      </button>
                    </div>
                    {book?.discount !== 0 ? (
                      <button
              ...
              <div className="languages">
                ...
                <div className="languages-content">
                  <div className="languages-language specification-form">
                    <span className="language-label">Ngôn ngữ</span>
            ...
            <div className="total">
              <div className="total-Rating">
                <div className="rating-header">
                  ...
                  <div className="ratingHeader-reviews">2 đánh giá</div>
                </div>
              ...
              <div className="review-form-wrapper">
                <h4 className="review-title">THÊM ĐÁNH GIÁ</h4>
                <div className="review-form">
                  <p className="comment-notes">
                    <span className=" notes">
                      Chúc bạn có những trải nghiệm tốt đẹp nhất khi mua sách ở
                      trang của chúng tôi❤️
                    </span>
                  </p>
                  <div className="comment-form-rating">
                    <label htmlFor="rating" className="mr-[10px]">
                      <span className="rating">Xếp hạng của bạn</span>
                  ...
                  <p className="comment-form-comment">
                    <label htmlFor="comment">
                      <span className="comment">Đánh giá của bạn</span>
                      <span className="require">*</span>
                    </label>
                    <textarea
                      ref={cmtRef}
