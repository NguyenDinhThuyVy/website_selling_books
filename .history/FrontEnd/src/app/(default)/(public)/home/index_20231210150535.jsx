      ...
      <div className="mt-10 wrapper-content">
        <div className="w-full p-4 bg-white rounded-lg">
          <div className="flex items-center pb-2 border-b border-b-gray-500 gap-x-2">
            <BsFillBookmarkFill size="15px" color="#c95151c4" />
        ...
        <div className="w-full p-4 mt-10 bg-white rounded-lg">
          <div className="flex items-center pb-2 border-b border-b-gray-500 gap-x-2">
            <BsFillBookFill size="15px" color="#c95151c4" />
        ...
        <span className="flex justify-end mt-3">
          <Link
            href={routes.ALLBOOK}
            className="inline-block py-1 text-xs px-4 bg-[#c95151c4] text-white rounded-3xl hover:bg-opacity-70 transition-all"
          >
            Discover all
          </Link>
        </span>
